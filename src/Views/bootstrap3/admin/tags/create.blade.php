...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <form method="POST" action="{{ route($setting->grab('main_route_path').'.tags.save') }}">
                ...
                {{ csrf_field() }}
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="icon" placeholder="Name" name="name" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
