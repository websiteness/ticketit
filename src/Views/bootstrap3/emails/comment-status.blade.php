...
@section('content')
	{{-- {!! trans('ticketit::email/comment.data', [
	  ...
	  <p class="email-template__message" style="line-height: 1.4em;font-size: 15px;">{{config('app.name')}} support has replied to the ticket you created and changed the status of the ticket.</p>
