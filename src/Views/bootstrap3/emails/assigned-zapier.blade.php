...
@section('content')
	...
	<table class="email-template__schedule" style="margin: 50px auto;width: 100%;">
	  <tbody>
	    <tr>
	      <td colspan="2" style="padding: 5px 10px 5px 0;width: 100px;"><span class="heading-bold" style="font-weight: 600;">Ticket #:</span></td>
	      {{-- <td> {{ $ticket->id }} </td> --}}
	    </tr>
	    <tr>
	    ...
	    <tr>
	      <td colspan="2" style="padding: 5px 10px 5px 0;width: 100px;"><span class="heading-bold" style="font-weight: 600;">Date:</span></td>
	    </tr>
	    <tr>
	      <td colspan="2"> {{ $ticket->created_at->toDayDateTimeString() }} </td>
	    </tr>
	    <tr>
	      <td colspan="2" style="padding: 5px 10px 5px 0;width: 100px;"><span class="heading-bold" style="font-weight: 600;">Title:</span></td>
	    </tr>
	    <tr>
	      <td colspan="2"> {{ $ticket->subject }} </td>
	    </tr>
	    <tr>
	      <td colspan="2" style="padding: 5px 10px 5px 0;width: 100px;"><span class="heading-bold" style="font-weight: 600;">User:</span></td>
	    </tr>
	    <tr>
	      <td colspan="2"> {{ $notification_owner->name }} </td>
	    </tr>
	    <tr>
	      <td colspan="2" style="padding: 5px 10px 5px 0;width: 100px;"><span class="heading-bold" style="font-weight: 600;">Status:</span></td>
	    </tr>
	    <tr>
	      <td colspan="2"> {{ $ticket->status->name }} </td>
	    </tr>
	    <tr>
	      <td colspan="2" style="padding: 5px 10px 5px 0;width: 100px;"><span class="heading-bold" style="font-weight: 600;">Category:</span></td>
	    </tr>
	    <tr>
	      <td colspan="2"> {!! ($ticket->category->parent_category) ? $ticket->category->parent_category->name : $ticket->category->name !!} </td>
	    </tr>
	    @if ($ticket->category->parent_category)
		    <tr>
		      <td colspan="2" style="padding: 5px 10px 5px 0;width: 100px;"><span class="heading-bold" style="font-weight: 600;">Sub Category: </span></td>
		    </tr>
		    <tr>
	    ...
	    @endif
	    <tr>
	      <td colspan="2" style="padding: 5px 10px 5px 0;width: 100px;"><span class="heading-bold" style="font-weight: 600;">Images/Links: </span></td>
	    </tr>
	    <tr>
	      <td colspan="2"> 
	    ...
	    <tr>
	      <td colspan="2" style="padding: 5px 10px 5px 0;width: 100px;"><span class="heading-bold" style="font-weight: 600;">Ticket Url: </span></td>
	    </tr>
	    <tr>
	      <td colspan="2"> <a href="{{ route($setting->grab('main_route').'.show', $ticket->id) }}">{{ route($setting->grab('main_route').'.show', $ticket->id) }}</a>
	      </td>
	    </tr>
	    <tr>
