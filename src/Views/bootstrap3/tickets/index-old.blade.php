                                            ...
                                            <li class="main_alphabet">
                                                ...
                                                <li class="main_sub_alphabet search_term search_term_companies" data-search-term="tesla" data-name="Tesla">
                                                    ...
                                                    <li class="main_sub_alphabet search_term search_term_companies " data-search-term="tesla" data-name="Tesla">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" data-column="1" value="1"  class="ticket_dropdown_option company-checkboxes company-checkboxes_131">
                                                                User
                                                            </label>
                                                        </div>
                                                    </li>
                                                    <li class="main_sub_alphabet search_term search_term_companies " data-search-term="test company" data-name="Test Company">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" data-column="2" value="2"  class="ticket_dropdown_option company-checkboxes company-checkboxes_132">
                                                                Subject
                                                            </label>
                                                        </div>
                                                    </li>
                                                    <li class="main_sub_alphabet search_term search_term_companies " data-search-term="test company" data-name="Test Company">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" data-column="3" value="3" class="ticket_dropdown_option company-checkboxes company-checkboxes_132">
                                                               Ticket Status
                                                            </label>
                                                        </div>
                                                    </li>
                                                    <li class="main_sub_alphabet search_term search_term_companies " data-search-term="test company" data-name="Test Company">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" data-column="4" value="4"  class="ticket_dropdown_option company-checkboxes company-checkboxes_132">
                                                                Priority
                                                            </label>
                                                        </div>
                                                    </li>
                                                    <li class="main_sub_alphabet search_term search_term_companies " data-search-term="test company" data-name="Test Company">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" data-column="5" value="5"  class="ticket_dropdown_option company-checkboxes company-checkboxes_132">
                                                                Dev Status
                                                            </label>
                                                        </div>
                                                    </li>
